...
export type ILineItemOverrideRepository = IRepository<s.lineitem_overrides.Insertable, s.lineitem_overrides.Updatable, s.lineitem_overrides.JSONSelectable, s.lineitem_overrides.Whereable, s.lineitem_overrides.Table>
...
class LineItemOverrideRepository implements ILineItemOverrideRepository {
  constructor (private pool: Pool) { }
    ...
    // eslint-disable-next-line camelcase
      ...
      // eslint-disable-next-line camelcase
      const lineItemsSql = db.select('lineitem_overrides', lineItem || {})
